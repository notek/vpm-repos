...
description: "VPMリポジトリへの公開パッケージ追加・バージョン更新。Use when: パッケージ追加, バージョン更新, VPM, index.json 編集, パッケージ公開"
argument-hint: "パッケージ名とバージョン（新規ならdescriptionも）"
---

# VPM パッケージ追加・更新

docs/index.json を編集して VPM リポジトリにパッケージを追加または更新する。
...
### 2. docs/index.json を読み込む

現在の index.json の全体構造を読み取る。
